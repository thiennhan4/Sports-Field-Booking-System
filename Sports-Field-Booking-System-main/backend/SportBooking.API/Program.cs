...
// Redis Registration — tolerate startup when Redis is not yet running
...
using (var scope = app.Services.CreateScope())
{
    ...
    var slotGenerator = scope.ServiceProvider.GetRequiredService<ISlotGenerator>();
    await slotGenerator.GenerateSlotsForNext30DaysAsync();
}
...
RecurringJob.AddOrUpdate<ISlotGenerator>(
    "slot-generation-job",
