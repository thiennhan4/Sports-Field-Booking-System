        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialPricePerHour = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HolidayPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HolidayPrices_Venues_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_CourtId_Date_StartTime_EndTime",
                table: "TimeSlots",
                columns: new[] { "CourtId", "Date", "StartTime", "EndTime" },
                unique: true);
        }
